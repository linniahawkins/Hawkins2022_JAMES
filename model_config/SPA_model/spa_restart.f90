...
contains
  ...
  subroutine write_restart_file( time, plant_func_type )
    ...
    integer, intent(in)          :: plant_func_type
    ...
    case ( 2 , 3 )
      ! crops..
      write(restart_name,'(a18,i0.2,a3)') "crops.restart.",time%year,".nc"
    endselect
  ...
  subroutine setup_restart_lists()
    ...
    call append( restart_var_list , get_item( spa_vars , 'latitude'                          ) )
    ...
    call append( restart_var_list , get_item( spa_vars , 'LCA'                               ) )
    ...
    call append( restart_var_list , get_item( spa_vars , 'stock_dead_foliage'                ) )
    call append( restart_var_list , get_item( spa_vars , 'stock_surface_litter'              ) )
    call append( restart_var_list , get_item( spa_vars , 'stock_storage_organ'               ) )
